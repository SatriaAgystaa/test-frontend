<template>
  <div class="relative w-full aspect-square max-w-[290px] mx-auto">
    ...
    <div class="absolute inset-0 flex items-center justify-center z-10 right-[-20%] sm:right-[-25%] top-0">
      <img 
        src="/public/assets/icons/BaseIcons/vinyl2.svg" 
        alt="Vinyl Record"
    ...
    <div class="absolute top-0 right-7 w-full h-full z-20">
      <div class="w-full h-full bg-gray-200 overflow-hidden shadow-lg relative">
        ...
        >
          <img src="/public/assets/icons/BaseIcons/play.svg" alt="Play" class="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" />
        </button>
      </div>
    </div>
    ...
    >
      <img src="/public/assets/icons/BaseIcons/like_black.svg" alt="Like" class="w-4 h-4 sm:w-[18px] sm:h-[18px] md:w-5 md:h-5 transition-all duration-300" />
    </button>
  </div>
</template>
